...
> 关联笔记：[[DGX-Spark-三节点-DSV4.1部署断点]] · [[DGX-Spark-三节点-DSV4.1部署-避坑清单]]
> 现场文档（`AIWorkspace/dsv41-fq-3xspark/`，head 的 `~/dsv41-3xspark/` 有副本）：
> `SESSION-HANDOFF-2026-09-18.md`（总交接）· `ROCE-FINDINGS-2026-09-18.md`（RoCE 专项）· `SPS-TABLE-2026-09-18.md`（SPS 表专项）
>
...
```
管理网 WiFi wlP9s9      01=192.168.0.101（头）  02=192.168.0.103  03=192.168.0.103
...
| 03 | 10.100.178.1 | 10.100.176.1 | 10.100.179.1 | 10.100.177.1 |

**线缆（按共用 /24 判断）**

```
W1 = 01-p0 ↔ 03-p0      W2 = 01-p1 ↔ 02-p0      W3 = 02-p1 ↔ 03-p1
